...
import { SatsParamSchema } from "../stats/stats.schema";
...
export const recent = createRoute({
  ...
  responses: {
    [HttpStatusCodes.OK]: jsonContent(
      z.array(RecentOrderSchema),
      "The list of recent orders"
    ),
  },
});
...
export const create = createRoute({
  ...
  responses: {
    ...
    [HttpStatusCodes.CONFLICT]: jsonContent(
      z.object({ message: z.string() }),
      "Order with this order number or tracking number already exists"
    ),
  },
});
...
export const remove = createRoute({
  ...
  responses: {
    ...
    [HttpStatusCodes.BAD_REQUEST]: jsonContent(
      z.object({ message: z.string() }),
      "Cannot delete order that is delivered or in progress"
    ),
  },
});
...
export type RecentOrderRoute = typeof recent;
export type UserOrdersRoute = typeof userOrders;
