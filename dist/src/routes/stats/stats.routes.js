...
import { ItemsResponseSchema, SatsParamSchema, SatsResponseParamSchema, StatsResponseSchema, } from "./stats.schema.js";
...
export const list = createRoute({
    ...
    responses: {
        ...
        [HttpStatusCodes.UNAUTHORIZED]: jsonContent(NotAuthorizedSchema, "You need to be Authenticated to View Stats"),
    },
});
