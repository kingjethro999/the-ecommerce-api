...
import { DeleteResponseSchema, NotFoundSchema, postResponseSchema, } from "../../lib/constants.js";
import { BriefUserSchema, ClerkUserSchema, CreateUserSchema, CustomerOrderSchema, CustomerSchema, IdParamSchema, UpdateUserSchema, UserSchema, } from "./users.schema.js";
...
export const list = createRoute({
    ...
    tags,
    responses: {
        [HttpStatusCodes.OK]: jsonContent(z.array(BriefUserSchema), "The List of Users"),
    },
});
export const customers = createRoute({
    ...
    tags,
    responses: {
        [HttpStatusCodes.OK]: jsonContent(z.array(CustomerSchema), "The List of customers"),
    },
});
export const create = createRoute({
    ...
    responses: {
        ...
        [HttpStatusCodes.UNPROCESSABLE_ENTITY]: jsonContent(createErrorSchema(CreateUserSchema), "The Validation Errors"),
    },
});
...
export const customerOrders = createRoute({
    ...
    tags,
    responses: {
        [HttpStatusCodes.OK]: jsonContent(CustomerOrderSchema, "The requested User"),
        [HttpStatusCodes.UNPROCESSABLE_ENTITY]: jsonContent(IdParamSchema, "Invalid Id Error"),
        [HttpStatusCodes.NOT_FOUND]: jsonContent(NotFoundSchema, "User Not Found"),
    },
});
export const update = createRoute({
    ...
    responses: {
        ...
        [HttpStatusCodes.NOT_FOUND]: jsonContent(NotFoundSchema, "User Not Found"),
        [HttpStatusCodes.UNPROCESSABLE_ENTITY]: jsonContentOneOf([createErrorSchema(UpdateUserSchema), createErrorSchema(IdParamSchema)], "The Validation Errors"),
    },
});
