...
import { BrandSchema, BrandWithRelationsSchema, CreateBrandSchema, IdParamSchema, UpdateBrandSchema, } from "./brands.schema.js";
const tags = ["Brands"];
export const list = createRoute({
    ...
    tags,
    responses: {
        [HttpStatusCodes.OK]: jsonContent(z.array(BrandSchema), "The list of brands"),
    },
});
export const create = createRoute({
    ...
    responses: {
        ...
        [HttpStatusCodes.UNPROCESSABLE_ENTITY]: jsonContent(createErrorSchema(CreateBrandSchema), "The validation errors"),
        [HttpStatusCodes.UNAUTHORIZED]: jsonContent(NotAuthorizedSchema, "You need to be authenticated to create"),
        [HttpStatusCodes.CONFLICT]: jsonContent(z.object({ message: z.string() }), "Brand with this slug already exists"),
    },
});
export const getOne = createRoute({
    ...
    tags,
    responses: {
        [HttpStatusCodes.OK]: jsonContent(BrandWithRelationsSchema, "The requested brand"),
...
export const update = createRoute({
    ...
    responses: {
        ...
        [HttpStatusCodes.UNPROCESSABLE_ENTITY]: jsonContent(createErrorSchema(UpdateBrandSchema), "The validation errors"),
...
export const remove = createRoute({
    ...
    responses: {
        ...
        [HttpStatusCodes.BAD_REQUEST]: jsonContent(z.object({ message: z.string() }), "Cannot delete brand with existing products"),
    },
});
